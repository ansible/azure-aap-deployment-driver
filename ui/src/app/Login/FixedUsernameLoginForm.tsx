...
// Note: Duplicate of LoginForm from Patternfly, but with property to disable the username text box (usernameDisabled)

export interface FixedUsernameLoginFormProps extends Omit<React.HTMLProps<HTMLFormElement>, 'ref'> {
...
export const FixedUsernameLoginForm: React.FunctionComponent<FixedUsernameLoginFormProps> = ({
  noAutoFocus = false,
  className = '',
...
FixedUsernameLoginForm.displayName = 'LoginForm';
